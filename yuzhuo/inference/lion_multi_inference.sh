#!/bin/bash
#SBATCH --job-name=lion-multi
#SBATCH --time=9999:00:00
#SBATCH --open-mode=append
#SBATCH --output=/data/yil708/ARK/logs/slurm_lion_multi_%j.out
#SBATCH --error=/data/yil708/ARK/logs/slurm_lion_multi_%j.err
#SBATCH --gres=gpu:1
...
# PROTOCOL_FILTER=p1 sbatch lion_multi_inference.sh
# OLLAMA_PORT=23456 sbatch lion_multi_inference.sh
