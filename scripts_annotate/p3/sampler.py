...
class MultiIdentitySampler:
    def __init__(
        ...
        """
        Initialize the MultiIdentitySampler for Protocol 3.
        ...
        if self.num_positives < 2:
            raise ValueError(
                "Protocol 3 requires at least 2 positive images in the gallery."
            )
    ...
    def _scan_directory(self):
        ...
        print("Initialization Complete (Protocol 3 - Multi-Identity Association).")
        print(
    ...
    def generate_sample(self) -> Optional[Dict[str, Any]]:
        ...
        return {
            "task_id": f"{self.dataset_name}_MIA_P3_{self.sample_counter:06d}",
            "query": {"image_path": query_img, "ground_truth_id": query_id},
            "gallery": formatted_gallery,
            "answer": answer_str,
            "meta": {"num_positives": self.num_positives, "protocol": "P3"},
        }
